...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get settingsCategoryTimeTracking => 'Suivi du temps';
  ...
  String settingsUpdateInstallErrorPermission(String path) {
    return 'Hickory ne peut pas remplacer son dossier d\'installation ($path). Cela arrive lorsque l\'app appartient à un autre compte utilisateur. Déplacez-la dans votre propre dossier Applications, ou mettez à jour manuellement depuis GitHub.';
  }

  @override
  String settingsUpdateDownloading(String received, String total) {
    return 'Téléchargement de la mise à jour … $received sur $total Mo';
  }

  @override
  String settingsUpdateDownloadingUnknownSize(String received) {
    return 'Téléchargement de la mise à jour … $received Mo';
  }
  ...
  @override
  String get settingsUpdateExtracting => 'Extraction de la mise à jour …';
  ...
  @override
  String get migrationFailedTitle => 'Impossible de reprendre vos données';

  @override
  String migrationFailedMessage(String path, String error) {
    return 'Hickory a trouvé vos données existantes mais n\'a pas pu les copier vers leur nouvel emplacement. L\'app s\'arrête volontairement ici, afin de ne pas créer une base vide et de garder les anciennes données accessibles. Elles se trouvent dans :\n\n$path\n\nLa version précédente peut toujours les ouvrir. Erreur : $error';
  }
  ...
  @override
  String get entriesUpOneLevelTooltip => 'Remonter d’un niveau';

  @override
  String get entriesAllYearsLabel => 'Toutes les années';
  ...
  String entriesBreakInsufficientDaysTooltip(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count jours avec des pauses trop courtes',
      one: '1 jour avec une pause trop courte',
    );
    return '$_temp0';
  }
  ...
  @override
  String get quickAddSubmitLabel => 'Ajouter une entrée';
