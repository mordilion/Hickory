...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get settingsUpdateInstallErrorPermission =>
      'Hickory can\'t write to its installation folder: the app runs in the macOS sandbox, which blocks that regardless of folder permissions. Download the new version from GitHub and replace the app in Finder.';
  ...
  @override
  String get entriesUpOneLevelTooltip => 'Up one level';

  @override
  String get entriesAllYearsLabel => 'All years';
  ...
  String entriesBreakInsufficientDaysTooltip(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count days with breaks that are too short',
      one: '1 day with a break that is too short',
    );
    return '$_temp0';
  }
