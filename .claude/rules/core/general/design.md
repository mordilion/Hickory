...
> **ALWAYS**: Apply the full accessibility rules from `accessibility.md` (keyboard navigation, focus styles, semantics, contrast, accessible names) — they are part of every UI task.
